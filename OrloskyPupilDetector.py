...
def select_video():
    ...
    # Check for test video in current directory first
    video_path = os.path.join(os.path.dirname(__file__), 'eye_test.mp4')
    if not os.path.exists(video_path):
        print("Test video not found. Please select a video file.")
